                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        @if(auth()->user()->isAdmin())
                            <input type="number" step="0.01" min="0" max="100" class="form-control @error('commission_rate') is-invalid @enderror" name="commission_rate" value="{{ old('commission_rate', $property->commission_rate) }}" placeholder="e.g. 2">
                        ...
                        @else
                            <input type="number" step="0.01" min="0" max="100" class="form-control" name="commission_rate" value="{{ old('commission_rate', $property->commission_rate) }}" disabled>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror" name="latitude" value="{{ old('latitude', $property->latitude) }}" placeholder="e.g. 33.6844">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="any" class="form-control @error('longitude') is-invalid @enderror" name="longitude" value="{{ old('longitude', $property->longitude) }}" placeholder="e.g. 73.0479">
