                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="caller_role" class="form-select">
                            ...
                            <option value="seller" @selected(old('caller_role') == 'seller')>Seller <span class="urdu">(بیچنے والا)</span></option>
                            <option value="buyer" @selected(old('caller_role') == 'buyer')>Buyer <span class="urdu">(خریدنے والا)</span></option>
                        </select>
                    </div>
                    <div class="mb-3">
