...
@section('title', 'Add Rent Agreement <span class="urdu">(نیا کرایہ نامہ)</span>')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add Rent Agreement <span class="urdu">(نیا کرایہ نامہ)</span></li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-header flex-wrap gap-2">
        <h4><i class="ti ti-file-text"></i> Add New Rent Agreement <span class="urdu">(نیا کرایہ نامہ)</span></h4>
    </div>
    <form action="{{ route('rent-agreements.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('tenant_id') is-invalid @enderror" name="tenant_id" required>
                            ...
                            @foreach($clients ?? [] as $client)
                                <option value="{{ $client->id }}" {{ old('tenant_id') == $client->id ? 'selected' : '' }}>{{ $client->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('rent_amount') is-invalid @enderror" name="rent_amount" value="{{ old('rent_amount') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('security_deposit') is-invalid @enderror" name="security_deposit" value="{{ old('security_deposit') }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" class="form-control @error('notice_period_days') is-invalid @enderror" name="notice_period_days" value="{{ old('notice_period_days', 30) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('late_fee_per_day') is-invalid @enderror" name="late_fee_per_day" value="{{ old('late_fee_per_day') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" max="100" class="form-control @error('rent_increase_percent') is-invalid @enderror" name="rent_increase_percent" value="{{ old('rent_increase_percent') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Accepted: PDF, JPG, PNG, DOC. Max 20MB.</div>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-dark"><i class="ti ti-device-floppy"></i> Save Agreement <span class="urdu">(کرایہ نامہ محفوظ کریں)</span></button>
