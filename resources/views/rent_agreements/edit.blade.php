                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('rent_increase_frequency') is-invalid @enderror" name="rent_increase_frequency">
                            <option value="none" {{ old('rent_increase_frequency', $rentAgreement->rent_increase_frequency ?? 'none') == 'none' ? 'selected' : '' }}>None</option>
                            <option value="monthly" {{ old('rent_increase_frequency', $rentAgreement->rent_increase_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                            <option value="quarterly" {{ old('rent_increase_frequency', $rentAgreement->rent_increase_frequency) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('payment_frequency') is-invalid @enderror" name="payment_frequency">
                            <option value="monthly" {{ old('payment_frequency', $rentAgreement->payment_frequency ?? 'monthly') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                            <option value="quarterly" {{ old('payment_frequency', $rentAgreement->payment_frequency) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                            <option value="half-yearly" {{ old('payment_frequency', $rentAgreement->payment_frequency) == 'half-yearly' ? 'selected' : '' }}>Half-Yearly</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" name="status">
                            ...
                            <option value="renewed" {{ old('status', $rentAgreement->status) == 'renewed' ? 'selected' : '' }}>Renewed</option>
                        </select>
                        @error('status') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Terms & Conditions <span class="urdu">(شرائط و ضوابط)</span></label>
                        <textarea class="form-control @error('terms') is-invalid @enderror" name="terms" rows="4">{{ old('terms', $rentAgreement->terms) }}</textarea>
