...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="ti ti-receipt me-1"></i> Edit Expense <span class="urdu">(اخراجات میں ترمیم)</span></h4>
...
<div class="card shadow-sm">
    <div class="card-body">
        <form action="{{ route('expenses.update', $expense) }}" method="POST">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="payment_method" class="form-select">
                            ...
                            <option value="raast" {{ old('payment_method', $expense->payment_method) === 'raast' ? 'selected' : '' }}>Raast</option>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="agent_id" class="form-select">
                            ...
                            <option value="{{ $agent->id }}" {{ old('agent_id', $expense->agent_id) == $agent->id ? 'selected' : '' }}>{{ $agent->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="deal_id" class="form-select">
                            ...
                            <option value="{{ $deal->id }}" {{ old('deal_id', $expense->deal_id) == $deal->id ? 'selected' : '' }}>{{ $deal->deal_number }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-dark"><i class="ti ti-check"></i> Update Expense</button>
