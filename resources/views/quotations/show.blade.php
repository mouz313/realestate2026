    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            ...
            <div class="col-6">
                ...
                <p class="mb-0 small text-secondary">{{ \App\Helpers\Status::categoryLabel($quotation->property->category) }} — {{ $quotation->property->plot_size }} {{ $quotation->property->plot_size_unit ?? '' }}</p>
                @endif
