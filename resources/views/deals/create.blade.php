...
@section('title', 'Add Deal <span class="urdu">(ڈیل شامل کریں)</span>')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add Deal <span class="urdu">(ڈیل شامل کریں)</span></li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-header d-flex flex-wrap gap-2">
        <h4><i class="ti ti-building-store"></i> <span class="urdu">(نئی ڈیل شامل کریں)</span></h4>
    </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('co_agent_id') is-invalid @enderror" name="co_agent_id">
                            ...
                            @foreach($agents ?? [] as $agent)
                                <option value="{{ $agent->id }}" {{ old('co_agent_id') == $agent->id ? 'selected' : '' }}>{{ $agent->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('sale_price') is-invalid @enderror" name="sale_price" value="{{ old('sale_price') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('agent_commission') is-invalid @enderror" name="agent_commission" value="{{ old('agent_commission') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('agency_share') is-invalid @enderror" name="agency_share" value="{{ old('agency_share') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('token_amount') is-invalid @enderror" name="token_amount" value="{{ old('token_amount') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('token_date') is-invalid @enderror" name="token_date" value="{{ old('token_date') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('agreement_date') is-invalid @enderror" name="agreement_date" value="{{ old('agreement_date') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('possession_date') is-invalid @enderror" name="possession_date" value="{{ old('possession_date') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('payment_plan') is-invalid @enderror" name="payment_plan" rows="3">{{ old('payment_plan') }}</textarea>
