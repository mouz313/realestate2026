...
@section('content')
<div class="mb-3">
    <h4 class="fw-semibold mb-0">Welcome, {{ auth()->user()->name }} <span class="badge bg-secondary">Staff</span></h4>
    <div class="text-secondary small">Your dashboard shows only what your role is permitted to access.</div>
</div>

{{-- KPI Cards — at a glance (each gated by permission) --}}
...
{{-- Monthly Trends --}}
@canany(['view_quotations', 'view_invoices'])
<div class="mt-4">
