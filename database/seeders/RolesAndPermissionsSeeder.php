...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    protected function seedPermissions(): void
    {
        $catalog = [
            ...
            'Installments' => [
                ['slug' => 'view_installments', 'name' => 'View Installments'],
                ['slug' => 'create_installments', 'name' => 'Create Installments'],
                ['slug' => 'edit_installments', 'name' => 'Edit Installments'],
                ['slug' => 'mark_installment_paid', 'name' => 'Mark Installment Paid'],
            ],
            'Rent' => [
                ['slug' => 'view_rent_agreements', 'name' => 'View Rent Agreements'],
                ['slug' => 'create_rent_agreements', 'name' => 'Create Rent Agreements'],
                ['slug' => 'edit_rent_agreements', 'name' => 'Edit Rent Agreements'],
                ['slug' => 'record_rent_payments', 'name' => 'Record Rent Payments'],
                ['slug' => 'waive_rent', 'name' => 'Waive Rent Payments'],
                ['slug' => 'settle_deposits', 'name' => 'Settle Deposits'],
                ['slug' => 'generate_rent_notices', 'name' => 'Generate Rent Notices'],
            ],
            'Visits' => [
